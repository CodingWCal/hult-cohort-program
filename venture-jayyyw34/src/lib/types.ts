...
export const TOWNS = [
  ...
  { name: "Maraval", island: "trinidad" },
  { name: "Diego Martin", island: "trinidad" },
  { name: "Petit Valley", island: "trinidad" },
  { name: "Carenage", island: "trinidad" },
  { name: "Chaguaramas", island: "trinidad" },
  { name: "Maracas", island: "trinidad" },
  { name: "San Juan", island: "trinidad" },
  { name: "Barataria", island: "trinidad" },
  { name: "Curepe", island: "trinidad" },
  { name: "St. Augustine", island: "trinidad" },
  { name: "Tunapuna", island: "trinidad" },
  { name: "Arouca", island: "trinidad" },
  { name: "Trincity", island: "trinidad" },
  { name: "Arima", island: "trinidad" },
  { name: "Chaguanas", island: "trinidad" },
  { name: "Cunupia", island: "trinidad" },
  { name: "Couva", island: "trinidad" },
  { name: "Gasparillo", island: "trinidad" },
  { name: "San Fernando", island: "trinidad" },
  { name: "Princes Town", island: "trinidad" },
  { name: "Debe", island: "trinidad" },
  { name: "Penal", island: "trinidad" },
  { name: "Siparia", island: "trinidad" },
  { name: "Point Fortin", island: "trinidad" },
  { name: "Sangre Grande", island: "trinidad" },
  { name: "Rio Claro", island: "trinidad" },
  { name: "Mayaro", island: "trinidad" },
  { name: "Toco", island: "trinidad" },
