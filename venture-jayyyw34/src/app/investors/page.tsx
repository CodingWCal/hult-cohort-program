  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-14">
      ...
      <p className="mt-4 text-xl text-[var(--muted)]">
        A micro-marketplace for homemade plates — cooks list a daily menu,
        neighbors reserve pickup on the block.
      </p>
      <dl className="mt-8 grid gap-5 text-sm md:grid-cols-2">
        <div>
          <dt className="text-[var(--muted)]">Problem</dt>
          <dd className="mt-1">
            Home cooks already sell through group chats and Instagram DMs.
            Neighbors want real food, not another national delivery fee.
          </dd>
        </div>
        <div>
          <dt className="text-[var(--muted)]">Wedge</dt>
          <dd className="mt-1">
            Daily menus + neighborhood pickup. Not a ghost-kitchen OS and not a
            30% delivery take-rate.
          </dd>
        </div>
        <div>
        ...
        <div>
          ...
          <dd className="mt-1">
            Angel conversation for a single-metro pilot (Greater Boston), food
            safety counsel, and cook onboarding — not a priced round in this
            package.
          </dd>
        </div>
      </dl>
