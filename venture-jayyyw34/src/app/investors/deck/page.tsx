const slides = [
  ...
  {
    kicker: "03 · WhatsApp is the current OS",
    title: "Homemade food in T&T already has an operating system. It is WhatsApp.",
    body: "Status updates, broadcast lists, “who want roti.” Demand is real. Inventory is not. LocalPlate is the public board those chats are missing — remaining servings, town, pickup window — then send the listing back into WhatsApp in one tap.",
  },
  {
    kicker: "04 · Solution",
    title: "Daily menus. Town pickup.",
    body: "Cooks post one dish, pepper, a price, a pickup window, and remaining servings. Neighbours filter Trinidad or Tobago and reserve a plate. Collect with a plate code. LocalPlate does not run a driver network.",
  },
  {
    kicker: "05 · Product",
