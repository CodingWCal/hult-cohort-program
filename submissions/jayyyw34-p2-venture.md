# P2 Venture submission — jayyyw34

**Product:** LocalPlate  
**Code + docs:** `venture-jayyyw34/`

| Item | Path |
|------|------|
| Business plan | `venture-jayyyw34/docs/business-plan.md` |
| Pitch deck | `venture-jayyyw34/docs/pitch-deck.md` (live: `/investors/deck`) |
