...
const SLIDES: { title: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "320 tracks × 30 interviewer questions (5 cutting-edge Edge prompts per track), each with scenario, playbook, debrief, and a local answer review with interview tips.",
