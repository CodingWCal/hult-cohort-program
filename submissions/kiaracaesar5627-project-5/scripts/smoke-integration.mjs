...
async function main() {
  ...
  const reg = await api("POST", "/v1/developer/apps", {
    ...
    repo_url:
      "https://github.com/rogerSuperBuilderAlpha/hult-cohort-program/tree/participants/summer26/phase-2-venture/kiaracaesar5627/submissions/kiaracaesar5627-project-5",
    icon_url: `${BASE}/icon`,
  });
